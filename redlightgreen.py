...
im1 = cv2.imread(r'C:\Users\ASUS\Dropbox\PC\Downloads\Squid-Game-main\Squid-Game-main\im1.png')
im2 = cv2.imread(r'C:\Users\ASUS\Dropbox\PC\Downloads\Squid-Game-main\Squid-Game-main\im2.png')
...
while True:
	...
	if inFrame == 1:
		if not(isInit):
			playsound(r"C:\Users\ASUS\Dropbox\PC\Downloads\Squid-Game-main\Squid-Game-main\greenLight.mp3")
			currWindow = im1
			startT = time.time()
			endT = startT
		...
		if (endT - startT) <= dur:
			...
			if cPos >= 100:
				...
				if not(isCinit):
					...
					cEnd = cStart
					currWindow = im2
					playsound(r"C:\Users\ASUS\Dropbox\PC\Downloads\Squid-Game-main\Squid-Game-main\redLight.wav")
		...
		# mainWin = np.concatenate(cv2.resize(frm, (800,400)), currWindow)
		frm = cv2.resize(frm, (800,400)) 
		mainWin = np.concatenate((frm , currWindow))
